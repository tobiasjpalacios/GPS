                ...
                <div class=" lista ">
                    <div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                         ...
                         <asp:LinkButton CssClass="btn btn-success ml-3 mt-5 col-10" ID="LinkButton3" Text="Menu principal" runat="server" />
                         <asp:LinkButton CssClass="btn btn-danger ml-3 mt-1 col-10" ID="LinkButton1" Text="Cerrar Sesión" runat="server" OnClick="lnkSalir_Click" />
            ...
            <div class="col-9">
                <div class=" text-center">
                    ...
                    <div class="row ml-5 mt-5">
                        ...
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="AddUsuario">
                        ...
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="GoProyectos">
                            <h5 class="card-title">Proyectos</h5>
                              <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="currentColor" class="bi bi-journal-medical" viewBox="0 0 16 16">
                        ...
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="InformeUsuario">
                        ...
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="CargaCentro">
                     ...
                     <div class="row ml-5 mt-5">
                           <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2  mb-1 mb-1" onserverclick="ListaUsuario">
                        ...
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="AddUsuario">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="currentColor" class="bi bi-journal-plus" viewBox="0 0 16 16">
                        ...
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="InformeUsuario">
                            <h5 class="card-title"> Configuracion Permisos </h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="85" height="85" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
                              <path d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364L.102 2.223zm13.37 9.019.528.026.287.445.445.287.026.529L15 13l-.242.471-.026.529-.445.287-.287.445-.529.026L13 15l-.471-.242-.529-.026-.287-.445-.445-.287-.026-.529L11 13l.242-.471.026-.529.445-.287.287-.445.529-.026L13 11l.471.242z"/>
                            </svg>
                        </button>
                        <button runat="server" type="button" class="btn btn-primary col ml-2 mr-2 mb-1" onserverclick="CargaCentro">
                            <h5 class="card-title">Informacion</h5>
                           <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
